...
export const fedreserveDataframeDescribeTool = tool('fedreserve_dataframe_describe', {
  ...
  input: z.object({
    name: z
      ...
      .optional()
      .describe(
        'Optional table name (df_XXXXX_XXXXX) to describe a single dataframe. Omit to list all.',
      ),
  }),
      ...
      .array(
        z
          .object({
            ...
            expires_at: z
              .string()
              .describe('ISO 8601 expiry timestamp. Sliding TTL refreshed on every dataframe op.'),
            ...
            column_schema: z
              ...
              .describe('Resolved column schema. All FRED dataframe columns are nullable.'),
          })
