...
# ==============================================================================
# --platform=$BUILDPLATFORM keeps the build on the host arch: Bun 1.4's JSC
# aborts under QEMU during multi-arch builds, and the emitted JS is
...
# --ignore-scripts skips dependency lifecycle scripts; the build only needs
# type declarations, not compiled native bindings.
